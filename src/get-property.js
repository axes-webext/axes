async function getProperty (element, props = ['value', 'src', 'href', 'textContent']) {
    ...
    for (let prop of props) {
        if (['value', 'src', 'href', 'textContent', 'innerHTML', 'outerHTML', 'currentSrc'].includes(prop)) {
...
getProperty.supportedProps = ['value', 'src', 'href', 'textContent', 'innerHTML', 'outerHTML', 'imageData', 'dataURL', 'originalDataURL'];
